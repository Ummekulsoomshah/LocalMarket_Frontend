    ...
    return (
        <div class='grid grid-cols-4 gap-3'>
            ...
            <div class="w-full max-w-sm bg-white border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class=" rounded-t-lg w-full ht-auto" src={img} alt="product image" />
                </a>
                <div class="px-3 pb-3">
                    <a href="#">
                        <h5 class="text-1xl font-semibold tracking-tight text-gray-900 dark:text-white">Apple Watch Series 7 GPS, Aluminium Case, Starlight Sport</h5>
                    </a>
                    ...
                    <div class="flex items-center justify-between ">
                        <span class="text-1xl font-bold text-gray-900 dark:text-white">$599</span>
